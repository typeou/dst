...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "Um.. I think I'll wait.",
			GENERIC = "I can't shave that!",
			NOBITS = "Bald! Bald! My Eyes!",
		},
		STORE =
		{
			GENERIC = "Maybe if I just move this here..",
			NOTALLOWED = "I'm just not trying hard enough.",
			INUSE = "Move it or lose it!",
		},
		RUMMAGE =
		{	
			GENERIC = "I can't do that.",
			INUSE = "Out of my way! That's mine!",	
		},
        COOK =
        {
            GENERIC = "Me? Cook? HA!",
            INUSE = "I hope you are making enough for me.",
            TOOFAR = "It's too far away!",
        },
        GIVE =
        {
            DEAD = "I take it.. you won't be needing this anymore?",
            SLEEPING = "Too unconscious to care.",
            BUSY = "Maybe later then?",
        },
        GIVETOPLAYER = 
        {
        ...
        WRITE =
        {
            GENERIC = "Nope.. Too many words",
            INUSE = "There's only room for one scribbler.",
        },
        CHANGEIN =
        {
            GENERIC = "Someone will see me.. in the nuuude.",
            BURNING = "It's too dangerous right now!",
            INUSE = "I need my own dressing room.",
        },
        ATTUNE =
        {
	...
	ANNOUNCE_ADVENTUREFAIL = "Figures..",
	ANNOUNCE_BEES = " NOT THE BEEEEEES!!!",
	ANNOUNCE_BOOMERANG = "Well! What goes around comes around.",
	ANNOUNCE_CHARLIE = "What was that?!",
	ANNOUNCE_CHARLIE_ATTACK = "OW! Charlie bit me!",
	ANNOUNCE_COLD = "I wish I still had some fur!",
	ANNOUNCE_HOT = "Why do I have all this fur!",
	ANNOUNCE_CRAFTING_FAIL = "It's.. missing something..",
	ANNOUNCE_DEERCLOPS = "Oh.. please no.",
	ANNOUNCE_DUSK = "Night. Night. Night. Night.",
	ANNOUNCE_EAT =
	{
		GENERIC = "Fuel for the body. Fuel for the mind!",
		PAINFUL = "Tastes like instant regret.",
		SPOILED = "That can't be good for me..",
		STALE = "*Gag* Yum..",
		INVALID = "No naturional value, what so ever.",
		YUCKY = "I've eaten many strange things. Let's not add this.",
	},
	ANNOUNCE_ENTER_DARK = "Yup. Can't see.",
	ANNOUNCE_ENTER_LIGHT = "MY EYES! Oh hey I can see!",
	...
	ANNOUNCE_HUNGRY = "I need sustanace!",
	...
	ANNOUNCE_INV_FULL = "I need more storage!",
	ANNOUNCE_KNOCKEDOUT = "Ugh, my head!",
	ANNOUNCE_LOWRESEARCH = "I didn't learn very much from that.",
	ANNOUNCE_MOSQUITOS = "My Blood! Get your own!",
    ANNOUNCE_NOWARDROBEONFIRE = "It's too dangerous right now!",
    ANNOUNCE_NODANGERGIFT = "Now is not the time for gifts.",
	ANNOUNCE_NODANGERSLEEP = "I can't sleep through this.",
	...
	ANNOUNCE_TORCH_OUT = "Anyone got another light?",
	...
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "Shocking.. isn't it!",

	ANNOUNCE_DAMP = "Moist.",
	ANNOUNCE_WET = "Not the time for a wet t-shirt contest.",
	ANNOUNCE_WETTER = "Soggy.",
	ANNOUNCE_SOAKED = "The last time I was this wet..",
	
	ANNOUNCE_BECOMEGHOST = "BooOOOOOooo! LaaAaame!",
	ANNOUNCE_GHOSTDRAIN = "My humanity is about to start slipping away...",

	DESCRIBE_SAMECHARACTER = "Would you do me? I'd do me.",
	
	BATTLECRY =
	{
		GENERIC = "I don't want to fight you.",
		PIG = "Ham!",
		PREY = "I will eat you then kill you!",
		SPIDER = "Eek! A spider!",
		SPIDER_WARRIOR = "Time to burn this place down!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "That's right! I better run!",
		PIG = "Didn't want ham anyway.",
		PREY = "I wanted to eat that..",
		SPIDER = "He's too gross, anyway.",
		SPIDER_WARRIOR = "Live to fight another day.",
	},
	DESCRIBE =
	{
